...
class BarangKeluarController extends Controller
{
    ...
    {
        $barang = BarangKeluar::where('active', 1)->orderBy('id', 'DESC')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $barang_keluar->nomor_surat = $request->nomor_surat ?? '';
            $barang_keluar->nomor_nota_dinas = $request->nomor_nota_dinas ?? '';
