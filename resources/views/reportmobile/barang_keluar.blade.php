    ...
    $(document).ready(function(){
        ...
        var barangMasukTable = $('#barang_keluar-table').DataTable({
            ...
            ajax: {
                ...
                url :"{{ url('reportmobile/barang_keluar') }}",
            },
            columns: [
        ...
        $('#filtering-report').on('click', function(e){
            ...
            barangMasukTable.ajax.url("{{ url('reportmobile/barang_keluar') }}?startDate=" + startDate + "&endDate=" + endDate + "&id_gudang=" + id_gudang).load();
        });
