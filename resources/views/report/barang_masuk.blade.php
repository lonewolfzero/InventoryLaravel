                            ...
                            <table class="table w-100" id="barang_masuk-table">
                                <thead>
                                    <tr>
                                        ...
                                        @if ( auth()->user()->hasPermission('report.detail_barang_masuk') )
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#filtering-report').on('click', function(e){
            ...
            barangMasukTable.ajax.url("{{ url('report/barang_masuk') }}?startDate=" + startDate + "&endDate=" + endDate + "&id_gudang=" + id_gudang).load();
        });
        ...
        $('#reset-filtering').on('click', function(e){
            cb(start, end);
            barangMasukTable.ajax.url("{{ url('report/barang_masuk') }}").load();
        });
