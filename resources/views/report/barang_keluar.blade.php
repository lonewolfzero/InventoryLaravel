                            ...
                            <table class="table w-100" id="barang_keluar-table">
                                <thead>
                                    <tr>
                                        ...
                                        @if ( auth()->user()->hasPermission('report.detail_barang_keluar') )
...
<script>
    ...
    $(document).ready(function(){
        ...
        var barangMasukTable = $('#barang_keluar-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                data : [
        ...
        $('#filtering-report').on('click', function(e){
            ...
            barangMasukTable.ajax.url("{{ url('report/barang_keluar') }}?startDate=" + startDate + "&endDate=" + endDate + "&id_gudang=" + id_gudang).load();
        });
