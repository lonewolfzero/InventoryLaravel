...
class CreateBrgkdBITrigger extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("DROP TRIGGER IF EXISTS `brgkd_b_i`;
        CREATE TRIGGER brgkd_b_i
        BEFORE INSERT
        ...
        begin 
            ...
            if ada < 1 then
                ...
                SET peringatan = CONCAT_WS('', 'Insert gagal : Tidak ada barang masuk untuk ', namabarang, ' dengan harga ', NEW.harga, 
