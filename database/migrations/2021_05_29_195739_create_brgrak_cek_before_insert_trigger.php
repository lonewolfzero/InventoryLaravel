...
class CreateBrgrakCekBeforeInsertTrigger extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("DROP TRIGGER IF EXISTS `brgrak_cek_before_insert`;
        CREATE TRIGGER brgrak_cek_before_insert
        BEFORE INSERT
        ...
        begin
            ...
            if ada > 0 then
                ...
                set peringatan = concat_ws('', 'Insert gagal : rak untuk ', namabarang, ' sudah ada di ', namagudang);
